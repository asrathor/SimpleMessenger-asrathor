...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
             ...
             * If not used, only one message can be send between the avds.
             */
            do {
                try {
                    /*
                     ...
                     * However, if onProgressUpdate(message) is called directly, it results in Fatal Exception AsyncTask1 while executing doInBackground() caused by android.view.ViewRootImpl$CalledFromWrongThreadException: Only the original thread that created a view hierarchy can touch its views.
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                /*
                 * As the name suggests, flush is used to flush the stream. If not used, it will result in NullPointerException
                 */
                output.flush();
